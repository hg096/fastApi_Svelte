<script>
    ...
    // fastapi('get', '/api/question/list', {}, (json) => { question_list = json.question_list })
    ...
    function get_question_list(_page) {
        ...
        fastapi( 'get', '/api/question/list', params, (json) => { question_list = json.question_list, $page = _page, total = json.total } )
    }
...
<div class="container my-3">
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <span class="text-danger small mx-2"> >>{question.answers.length}개 답변</span>
                {/if}
            </td>
    ...
    <ul class="pagination justify-content-center">
        ...
        <li class="page-item {$page >= total_page-1 && 'disabled'}">
            <button class="page-link" on:click="{() => get_question_list(total_page-1)}">끝</button>
        </li>
    </ul>
    <!-- 페이징처리 끝 -->
